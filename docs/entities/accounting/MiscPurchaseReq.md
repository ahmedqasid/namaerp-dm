...
<a href='#details'>details (MiscPurchaseReqLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (MiscReqExternalPaymentLine) </a> , <a href='#purchaseTermsLines'>purchaseTermsLines (MiscReqStandardTermsLine) </a> , <a href='#scheduleLines'>scheduleLines (MiscReqScheduledPayLine) </a>
</div>
