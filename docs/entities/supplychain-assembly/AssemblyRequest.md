...
<a href='#assemblyProcessLines'>assemblyProcessLines (AssemblyReqProcessLine) </a> , <a href='#coProds'>coProds (AssemblyReqCoProdLine) </a> , <a href='#details'>details (AssemblyRequestLine) </a> , <a href='#lines'>lines (AssemblyReqAddCostLine) </a>
</div>
