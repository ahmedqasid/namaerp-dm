# POS.POSPricingRangeExcludedInvoiceLine (Table Name: POSPricingRangeExcludedInvoiceLine)
...
</div><div class="row searchable" id="customer.code">
<div class="cell" data-label="Property">customer.code</div>
...
<div class="row searchable" id="customer.namaEntityType">
<div class="cell" data-label="Property">customer.namaEntityType</div>
...
<div class="row searchable" id="customer.namaGenRefId">
<div class="cell" data-label="Property">customer.namaGenRefId</div>
...
<div class="row searchable" id="customer.name1">
<div class="cell" data-label="Property">customer.name1</div>
...
<div class="row searchable" id="customer.name2">
<div class="cell" data-label="Property">customer.name2</div>
...
<div class="row searchable" id="dimensions.analysisSet.code">
<div class="cell" data-label="Property">dimensions.analysisSet.code</div>
...
<div class="row searchable" id="dimensions.analysisSet.id">
<div class="cell" data-label="Property">dimensions.analysisSet.id</div>
...
<div class="row searchable" id="dimensions.branch.code">
<div class="cell" data-label="Property">dimensions.branch.code</div>
...
<div class="row searchable" id="dimensions.branch.id">
<div class="cell" data-label="Property">dimensions.branch.id</div>
...
<div class="row searchable" id="dimensions.department.code">
<div class="cell" data-label="Property">dimensions.department.code</div>
...
<div class="row searchable" id="dimensions.department.id">
<div class="cell" data-label="Property">dimensions.department.id</div>
...
<div class="row searchable" id="dimensions.legalEntity.code">
<div class="cell" data-label="Property">dimensions.legalEntity.code</div>
...
<div class="row searchable" id="dimensions.legalEntity.id">
<div class="cell" data-label="Property">dimensions.legalEntity.id</div>
...
<div class="row searchable" id="dimensions.sector.code">
<div class="cell" data-label="Property">dimensions.sector.code</div>
...
<div class="row searchable" id="dimensions.sector.id">
<div class="cell" data-label="Property">dimensions.sector.id</div>
...
<div class="cell" data-label="Property">pricingRange</div>
<div class="cell" data-label="Column">posPricingRange</div>
<div class="cell" data-label="Arabic"></div>
<div class="cell" data-label="English"></div>
<div class="cell" data-label="Type">Reference</div>
<div class="cell" data-label="Foreign Table">

 [POS.POSPricingRange](/entities/system-tables/POS.POSPricingRange.md) 
</div>
</div>
