...
# POS.PosDefaultsTemplate (Table Name: PosDefaultsTemplate)
</div>

**Arabic:** قالب قيم افتراضيه لنقاط البيع -  قالب قيم افتراضيه لنقاط البيع
**English:** Pos Defaults Template -  Pos Defaults Template

<ContentFilter/>


<div class='searchable'>
<a href='#details'>details (PosDefaultsTemplateLine) </a>
</div>
...
**Table Name:** PosDefaultsTemplateLine, **Join Column:** defaultsTemplate_id
...
<div class="cell">Type</div>
<div class="cell">Foreign Table</div>
</div><div class="row searchable" id="details.dateValue">
<div class="cell" data-label="Property">details.dateValue</div>
<div class="cell" data-label="Column">dateValue</div>
<div class="cell" data-label="Arabic">القيمة | تاريخ</div>
<div class="cell" data-label="English">Value | Date</div>
<div class="cell" data-label="Type">DateAndTime</div>

</div>

<div class="row searchable" id="details.defaultsTemplate">
<div class="cell" data-label="Property">details.defaultsTemplate</div>
...
<div class="row searchable" id="details.field">
<div class="cell" data-label="Property">details.field</div>
...
<div class="row searchable" id="details.refValueCode">
<div class="cell" data-label="Property">details.refValueCode</div>
<div class="cell" data-label="Column">refValueCode</div>
<div class="cell" data-label="Arabic"></div>
<div class="cell" data-label="English"></div>
<div class="cell" data-label="Type">Text</div>
...
<div class="row searchable" id="details.refValueId">
<div class="cell" data-label="Property">details.refValueId</div>
<div class="cell" data-label="Column">refValueId</div>
<div class="cell" data-label="Arabic"></div>
<div class="cell" data-label="English"></div>
<div class="cell" data-label="Type">ID</div>
...
<div class="row searchable" id="details.refValueName1">
<div class="cell" data-label="Property">details.refValueName1</div>
<div class="cell" data-label="Column">refValueName1</div>
<div class="cell" data-label="Arabic"></div>
<div class="cell" data-label="English"></div>
<div class="cell" data-label="Type">Text</div>
...
<div class="row searchable" id="details.refValueName2">
<div class="cell" data-label="Property">details.refValueName2</div>
<div class="cell" data-label="Column">refValueName2</div>
<div class="cell" data-label="Arabic"></div>
<div class="cell" data-label="English"></div>
<div class="cell" data-label="Type">Text</div>
...
<div class="row searchable" id="details.refValueType">
<div class="cell" data-label="Property">details.refValueType</div>
<div class="cell" data-label="Column">refValueType</div>
<div class="cell" data-label="Arabic"></div>
<div class="cell" data-label="English"></div>
<div class="cell" data-label="Type">Text</div>
...
<div class="row searchable" id="details.textValue">
<div class="cell" data-label="Property">details.textValue</div>
<div class="cell" data-label="Column">textValue</div>
<div class="cell" data-label="Arabic">القيمة | نص</div>
<div class="cell" data-label="English">Value | Text</div>
<div class="cell" data-label="Type">Text</div>
