...
<a href='#customerCodes'>customerCodes (ReqCustomerItemCode) </a> , <a href='#details'>details (ReqItemDimensionsDetail) </a> , <a href='#keywordLines'>keywordLines (ReqItemKeywordLine) </a> , <a href='#manfCodes'>manfCodes (ReqManufacturerItemCode) </a> , <a href='#primConversionLines'>primConversionLines (ReqPrimaryConversionLine) </a> , <a href='#primaryUnits'>primaryUnits (ReqPrimaryItemUOMLine) </a> , <a href='#revisions'>revisions (RequestItemRevision) </a> , <a href='#secondConversionLines'>secondConversionLines (ReqSecondaryConversionLine) </a> , <a href='#secondaryUnits'>secondaryUnits (ReqSecondaryItemUOMLine) </a> , <a href='#sizesAndColors'>sizesAndColors (ReqSizesAndColors) </a>
</div>
