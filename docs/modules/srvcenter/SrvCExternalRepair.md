...
<a href='#details'>details (SrvCExternalRepairLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (SrvCExRpExteranlPaymentLine) </a> , <a href='#paymentLines'>paymentLines (SrvCExRepPaymentLine) </a> , <a href='#scheduleLines'>scheduleLines (SrvCExRepScheduledPayLine) </a>
</div>
