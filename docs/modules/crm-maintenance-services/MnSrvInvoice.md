...
<a href='#dysfunctions'>dysfunctions (MnSrvInvoiceDysFunction) </a> , <a href='#maintenanceGroups'>maintenanceGroups (MnSrvInvoiceGroup) </a> , <a href='#orders'>orders (MnSrvInvoiceOrders) </a> , <a href='#returnedSpareParts'>returnedSpareParts (MnSrvInvoiceRetSpareLine) </a> , <a href='#spareParts'>spareParts (MnSrvInvoiceSparePart) </a> , <a href='#srvServices'>srvServices (MnSrvInvoiceLine) </a> , <a href='#technicians'>technicians (MnSrvInvoiceTechnician) </a> , <a href='#tools'>tools (MnSrvInvoiceTool) </a>
</div>
