...
**Arabic:** أمر صرف - أوامر صرف
**English:** Payment Order - Payment Orders

<ContentFilter/>


<div class='searchable'>
<a href='#costLines'>costLines (PaymentOrderCostLine) </a> , <a href='#fblines'>fblines (PaymentOrderFPDetailLine) </a> , <a href='#installmentLines'>installmentLines (PVOrderInstallmentLine) </a> , <a href='#invoices'>invoices (PVOrderInvoiceLine) </a> , <a href='#lines'>lines (PaymentOrderDetailLine) </a> , <a href='#paymentLines'>paymentLines (PaymentOrderPaymentLine) </a>
</div>
...
<div class="row searchable" id="poroStatus">
<div class="cell" data-label="Property">poroStatus</div>
...
**Table Name:** PaymentOrderCostLine, **Join Column:** paymentOrder_id
...
**Table Name:** PaymentOrderFPDetailLine, **Join Column:** paymentOrder_id
...
**Table Name:** PVOrderInstallmentLine, **Join Column:** paymentOrder_id
...
**Table Name:** PVOrderInvoiceLine, **Join Column:** paymentOrder_id
...
**Table Name:** PaymentOrderDetailLine, **Join Column:** paymentOrder_id
...
**Table Name:** PaymentOrderPaymentLine, **Join Column:** paymentOrder_id
