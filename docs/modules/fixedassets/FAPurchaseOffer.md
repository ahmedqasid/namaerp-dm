...
<a href='#details'>details (FAPurchaseOfferLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (FAOfferExternalPaymentLine) </a> , <a href='#purchaseTermsLines'>purchaseTermsLines (FAOfferOStandardTermsLine) </a> , <a href='#scheduleLines'>scheduleLines (FAPurchaseOfferScheduledPay) </a>
</div>
