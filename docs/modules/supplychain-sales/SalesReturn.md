...
<a href='#details'>details (SalesReturnLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (SalesReturnExternalPaymentLine) </a> , <a href='#generatedDocs'>generatedDocs (SRetGeneratedDocsLine) </a> , <a href='#installmentLines'>installmentLines (SalesReturnInstalSchedLine) </a> , <a href='#paymentLines'>paymentLines (SalesReturnPaymentLine) </a> , <a href='#stockDocs'>stockDocs (SalesReturnReceipt) </a>
</div>
