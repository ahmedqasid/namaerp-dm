...
<a href='#details'>details (SalesReplacementReqLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (SalesReplacementReqExtPayment) </a> , <a href='#paymentLines'>paymentLines (SalesReplacementReqPayment) </a> , <a href='#scheduleLines'>scheduleLines (SalesReplacementReqSchedulPay) </a> , <a href='#terms'>terms (SalesReplacementReqStandTerms) </a>
</div>
