...
<a href='#details'>details (ProformaSalesInvoiceLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (ProformaSalExternalPayLine) </a> , <a href='#packingList'>packingList (ProformaPackingListLine) </a> , <a href='#paymentLines'>paymentLines (ProformaSInvPaymentLine) </a> , <a href='#scheduleLines'>scheduleLines (ProformaSInvSchedPayLine) </a> , <a href='#termsLines'>termsLines (ProformaSInvStandTermLine) </a>
</div>
