...
**Arabic:** سند استبدال مبيعات - سندات استبدال مبيعات
**English:** Sales Replacement - Sales Replacements

<ContentFilter/>


<div class='searchable'>
<a href='#details'>details (SalesReplacementLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (SalesReplaceExtPaymentLine) </a> , <a href='#paymentLines'>paymentLines (SalesReplacementPaymentLine) </a> , <a href='#scheduleLines'>scheduleLines (SalesReplaceScheduledPayLine) </a> , <a href='#terms'>terms (SalesReplaceStandTermsLine) </a>
</div>
...
**Table Name:** SalesReplacementLine, **Join Column:** salesReplacement_id
...
**Table Name:** SalesReplaceExtPaymentLine, **Join Column:** salesReplacement_id
...
**Table Name:** SalesReplacementPaymentLine, **Join Column:** salesReplacement_id
...
**Table Name:** SalesReplaceScheduledPayLine, **Join Column:** salesReplacement_id
...
**Table Name:** SalesReplaceStandTermsLine, **Join Column:** salesReplacement_id
