...
<a href='#details'>details (REOpeningSalesLines) </a> , <a href='#installmentInfoLines'>installmentInfoLines (REOpeningSalesInstInfoLine) </a> , <a href='#lines'>lines (REOpeningSalesTermsConditions) </a> , <a href='#otherFeesLines'>otherFeesLines (REOpeningSalesFeesLine) </a> , <a href='#termLines'>termLines (REOpenSalesStandardTermLine) </a>
</div>
