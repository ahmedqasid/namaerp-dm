...
<a href='#details'>details (RESalesOfferLine) </a> , <a href='#installmentInfoLines'>installmentInfoLines (RESalesOfferInsInfoLine) </a> , <a href='#lines'>lines (RESalesOfferTermsConditions) </a> , <a href='#termLines'>termLines (RESalesOffStandardTermLine) </a>
</div>
