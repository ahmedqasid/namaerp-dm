...
# SIProformaPurchaseInvoice
</div>

**Arabic:** فاتورة مشتريات سيارة مبدئية - فواتير مشتريات سيارات مبدئية
**English:** Car Proforma Purchase Invoice - Car Proforma Purchase Invoices

<ContentFilter/>


<div class='searchable'>
<a href='#details'>details (SIProformaPurchaseInvoiceLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (SIProformaPurchaseInvExternalPay) </a> , <a href='#paymentLines'>paymentLines (SIPurchaseOrderPaymentLine) </a> , <a href='#scheduleLines'>scheduleLines (SIProformaPurchaseInvPaySchedule) </a>
</div>
...
**Table Name:** SIProformaPurchaseInvoiceLine, **Join Column:** sIProformaPurchaseInvoice_id
...
**Table Name:** SIProformaPurchaseInvExternalPay, **Join Column:** sIProformaPurchaseInvoice_id
...
**Table Name:** SIPurchaseOrderPaymentLine, **Join Column:** sIProformaPurchaseInvoice_id
...
**Table Name:** SIProformaPurchaseInvPaySchedule, **Join Column:** sIProformaPurchaseInvoice_id
