...
<a href='#details'>details (SISalesOrderLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (SISalesOrdExtPaymentLine) </a> , <a href='#paymentLines'>paymentLines (SISalesOrderPaymentLine) </a> , <a href='#scheduleLines'>scheduleLines (SISalesOrdScheduledPayLine) </a> , <a href='#termsLines'>termsLines (SISalesOStandardTermsLine) </a>
</div>
