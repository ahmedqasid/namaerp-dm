...
**Arabic:** مردودات مستلزمات طبية
**English:** Supply Return - Supply Returns

<ContentFilter/>


<div class='searchable'>
<a href='#details'>details (HMSSupplyReturnLine) </a>
</div>
...
**Table Name:** HMSSupplyReturnLine, **Join Column:** hMSSupplyReturn_id
