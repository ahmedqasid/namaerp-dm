...
<div class="row searchable" id="contractorExtract">
<div class="cell" data-label="Property">contractorExtract</div>
<div class="cell gen-ref-column" data-label="Column">contractorExtractActualCode,  contractorExtractCode,  contractorExtractEntityType,  contractorExtractId</div>
<div class="cell" data-label="Arabic">مستخلصات عقود المقاول الباطن</div>
<div class="cell" data-label="English">Contractor Extract</div>
<div class="cell" data-label="Type">Genericreference</div>
