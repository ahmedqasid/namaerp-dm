...
# ContractorMaterialIssueRequest
</div>

**Arabic:** طلب صرف خامات مقاول باطن - طلبات صرف خامات مقاول باطن
**English:** Contractor Material Issue Request - Contractor Material Issue Requests

<ContentFilter/>


<div class='searchable'>
<a href='#details'>details (ContractorIssueRequestLine) </a>
</div>
...
**Table Name:** ContractorIssueRequestLine, **Join Column:** contractorMaterialIssueRequest_id
