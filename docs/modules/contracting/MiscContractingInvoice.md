...
<a href='#details'>details (MiscContractingInvLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (MiscCIExternalPaymentLine) </a> , <a href='#purchaseTermsLines'>purchaseTermsLines (ContrPurchaseInvTermsLine) </a> , <a href='#scheduleLines'>scheduleLines (MiscContInvScheduledPayLine) </a>
</div>
