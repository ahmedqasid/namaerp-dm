...
# IPInvestmentPortfolio
</div>

**Arabic:** محفظة استثمارية - محافظ استثمارية
...
<a href='#details'>details (IPInvestmentPortfolioLine) </a>
</div>
...
**Table Name:** IPInvestmentPortfolioLine, **Join Column:** iPInvestmentPortfolio_id
