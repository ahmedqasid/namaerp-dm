...
<a href='#details'>details (TRPurchaseOrderLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (TRPurchaseOrderExternalPayLine) </a> , <a href='#scheduleLines'>scheduleLines (TRPurchaseOrderSchedulePayLine) </a> , <a href='#termLines'>termLines (TRPurchaseOrderStandardTermLine) </a>
</div>
