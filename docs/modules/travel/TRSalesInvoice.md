...
<a href='#details'>details (TRSalesInvoiceLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (TRSalesInvoiceExternalPayLine) </a> , <a href='#paymentLines'>paymentLines (TRSalesInvoicePaymentLine) </a> , <a href='#scheduleLines'>scheduleLines (TRSalesInvoiceSchedulePayLine) </a> , <a href='#termLines'>termLines (TRSalesInvoiceStandardTermLine) </a>
</div>
