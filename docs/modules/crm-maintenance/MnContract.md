...
<a href='#contractTerms'>contractTerms (MnContractTermLine) </a> , <a href='#externalPaymentLines'>externalPaymentLines (MnContractExternalPaymentLine) </a> , <a href='#machines'>machines (MnContractMachine) </a> , <a href='#scheduleLines'>scheduleLines (MnContractScheduledPayLine) </a> , <a href='#services'>services (MnContractService) </a> , <a href='#spareParts'>spareParts (MnContractSpareLine) </a> , <a href='#visits'>visits (MNContractVisitSchedule) </a>
</div>
