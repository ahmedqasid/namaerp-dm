...
<a href='#dysfunctions'>dysfunctions (MnInvoiceReturnDysfunction) </a> , <a href='#machines'>machines (MnInvoiceReturnMachine) </a> , <a href='#maintenanceGroups'>maintenanceGroups (MnInvoiceReturnGroup) </a> , <a href='#orders'>orders (MnInvoiceReturnOrders) </a> , <a href='#services'>services (MnInvoiceReturnSerivce) </a> , <a href='#spareParts'>spareParts (MnInvoiceReturnSparePart) </a> , <a href='#technicians'>technicians (MnInvoiceReturnTechnician) </a> , <a href='#tools'>tools (MnInvoiceReturnTool) </a>
</div>
