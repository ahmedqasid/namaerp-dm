...
<a href='#additionalSpareParts'>additionalSpareParts (MnOrderAdditionalSparePart) </a> , <a href='#dysfunctions'>dysfunctions (MnOrderDysfunction) </a> , <a href='#externalPaymentLines'>externalPaymentLines (MnOrderExternalPaymentLine) </a> , <a href='#machines'>machines (MnOrderMachine) </a> , <a href='#maintenanceGroups'>maintenanceGroups (MnOrderGroup) </a> , <a href='#paymentLines'>paymentLines (MnOrderPaymentLine) </a> , <a href='#returnedSpareParts'>returnedSpareParts (MnOrderRetSparePart) </a> , <a href='#services'>services (MnOrderSerivce) </a> , <a href='#spareParts'>spareParts (MnOrderSparePart) </a> , <a href='#statusChange'>statusChange (MnOrderStatusChangeLine) </a> , <a href='#technicians'>technicians (MnOrderTechnician) </a> , <a href='#termsLines'>termsLines (MnOrderStandardTermsLine) </a> , <a href='#tools'>tools (MnOrderTool) </a>
</div>
...
<div class="cell" data-label="Arabic">نوع الأمر</div>
