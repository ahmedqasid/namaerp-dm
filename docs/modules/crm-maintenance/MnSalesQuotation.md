...
<a href='#contractTerms'>contractTerms (MnSalesQuotationTermLine) </a> , <a href='#machines'>machines (MnSalesQuotationMachine) </a> , <a href='#services'>services (MnSalesQuotationService) </a> , <a href='#spareParts'>spareParts (MnSalesQuotationSpareLine) </a> , <a href='#visits'>visits (MnSalesQuotationVisitSchedule) </a>
</div>
