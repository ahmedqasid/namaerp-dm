...
<a href='#details'>details (RERentOfferLine) </a> , <a href='#discounts'>discounts (RERentOfferDiscountsLine) </a> , <a href='#expenses'>expenses (RERentOfferExpensesLine) </a> , <a href='#increases'>increases (RERentOfferIncreasesLine) </a> , <a href='#lines'>lines (RERentOfferTermsCond) </a> , <a href='#termLines'>termLines (RERentOffStandardTermLine) </a> , <a href='#yearlyPeriodTypes'>yearlyPeriodTypes (RERentOfferYearlyContractPayment) </a>
</div>
